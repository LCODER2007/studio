...
exports.onSuggestionStatusChange = exports.onVoteCreated = void 0;
...
exports.onVoteCreated = functions.firestore
    ...
    try {
        ...
        await db.runTransaction(async (transaction) => {
            ...
            const currentCount = ((_a = suggestionDoc.data()) === null || _a === void 0 ? void 0 : _a.upvotesCount) || 0;
 ...
 */
exports.onSuggestionStatusChange = functions.firestore
    ...
    try {
        ...
        const emailPromises = emailsToNotify.map(async (email) => {
            ...
            const emailBody = generateEmailBody(recipientName, afterData.title, statusLabel, afterData.publicFeedback, suggestionId);
            try {
 ...
 */
function generateEmailBody(recipientName, suggestionTitle, newStatus, publicFeedback, suggestionId) {
